...
function drawTable(messages) {
    ...
    rows.push([
        (0, node_util_1.styleText)("bold", "Line"),
        (0, node_util_1.styleText)("bold", "Column"),
        (0, node_util_1.styleText)("bold", "Type"),
...
function formatter(report, options) {
    ...
    const tableData = [];
    if (errorCount > 0) {
        tableData.push([(0, node_util_1.styleText)("red", (0, pluralize_1.default)("Error", errorCount, true))]);
    }
    if (warningCount > 0) {
        tableData.push([(0, node_util_1.styleText)("yellow", (0, pluralize_1.default)("Warning", warningCount, true))]);
    }
    if (infoCount > 0) {
        tableData.push([(0, node_util_1.styleText)("green", (0, pluralize_1.default)("Info", infoCount, true))]);
    }
